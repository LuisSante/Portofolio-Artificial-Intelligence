            ...
            >
                ...
                <div className="relative z-10 flex justify-center items-center">
                    <div className="relative flex flex-col justify-center items-center rounded-full font-bold text-4xl text-white size-44">
                        <div className="absolute bg-white/[0.8] dark:bg-black/[0.8] blur-sm rounded-full size-full" />
                        <span className="z-20 text-black dark:text-white whitespace-nowrap">{text}</span>
                        <span className="z-20 mt-4 text-black dark:text-white whitespace-nowrap">{icon}</span>
                    </div>
                </div>
            </div>
        </div>
